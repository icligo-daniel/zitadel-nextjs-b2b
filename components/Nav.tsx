        ...
        <div className="h-full max-w-7xl mx-auto flex items-center px-6">
          <div className="min-w-40 relative">
            <Link href="/" className="h-10 block">
              <img height={40} width={147.5} className="navimgd" src="/icligo-logo.png" alt="iCliGo logo" />
            </Link>

            <span className="text-xl font-bold absolute -bottom-2 -right-5 text-zitadelaccent-500">B2B</span>
          </div>
